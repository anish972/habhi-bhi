        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-16">
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-4 rounded-xl transition-all font-medium flex items-center shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40"
            >
