...
const FIVEM_PLANS = [
  {
    ...
    badge: "",
    promoTag: "STARTER",
    purchaseUrl: "/fivem/deploy/rookie"
  },
  {
    id: 2,
    title: "Professional",
    ...
    badge: "MOST POPULAR",
    promoTag: "BEST VALUE",
    purchaseUrl: "/fivem/deploy/professional"
  },
  {
    id: 3,
    title: "Enterprise",
    ...
    purchaseUrl: "/fivem/deploy/enterprise"
  }
];
  ...
  <div className="group bg-gradient-to-br from-gray-800/50 via-gray-800/30 to-gray-900/50 rounded-2xl backdrop-blur-sm border border-gray-700/50 hover:border-blue-500/50 transition-all duration-300 overflow-hidden">
    ...
    <div className="p-6">
      ...
      <div className="space-y-1 mb-6 border-t border-b border-gray-700/50 py-4">
        ...
        <SpecItem icon={Shield} spec={plan.specs.support} />
      </div>
...
export default function FiveMPage() {
  return (
    <section className="bg-gradient-to-b from-gray-900 via-gray-900 to-black py-24 relative overflow-hidden">
      <Helmet>
        <title>FiveM Hosting | GameHub</title>
        <meta name="description" content="Deploy a FiveM server for GTA V roleplay with custom scripts and anti-cheat." />
      </Helmet>
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl font-semibold text-gray-300 mb-8 max-w-3xl mx-auto">
            Create your own GTA V roleplay server with custom scripts
          </p>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            <StatCard icon={Shield} label="Anti-Cheat" value="Included" />
